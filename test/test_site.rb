...
class TestSite < Test::Unit::TestCase
  ...
  context "creating sites" do
    ...
    should "reset data before processing" do
      ...
      before_projects = @site.projects.length
      ...
      assert_equal before_projects, @site.projects.length
    ...
    should "deploy payload" do
      ...
      assert_equal projects, @site.projects.keys.sort
      assert_equal 5, @site.categories['foo'].size
      assert_equal 1, @site.projects['bartender'].size
    end
